    ...
    <div className="relative w-full min-w-[280px] md:min-w-[350px] h-auto transition-transform transform hover:scale-105">
      ...
      <div className="relative bg-white rounded-2xl shadow-xl p-6 md:p-8 flex flex-col justify-between border border-gray-200 hover:shadow-2xl transition-all duration-500 hover:border-transparent overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          {/* Task Priority Label */}
          <span className="inline-block bg-gradient-to-r from-yellow-500 to-yellow-400 text-white font-bold px-3 py-1 text-xs md:text-sm rounded-lg uppercase tracking-wide shadow-lg">
          {data.taskCategory}
          </span>

          {/* Task Title */}
          <h2 className="mt-4 text-2xl md:text-3xl font-extrabold text-yellow-800 leading-tight tracking-tighter">
          { data.taskTitle}
          </h2>

          {/* Task Description */}
          <p className="mt-3 text-sm md:text-base text-yellow-600 leading-relaxed">
        ...
        <div className="relative mt-6 py-4 px-4 bg-gradient-to-r from-yellow-400 to-yellow-500 rounded-xl shadow-lg">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-yellow-500 via-yellow-400 to-yellow-300 opacity-20 rounded-2xl pointer-events-none" />
      </div>
    </div>
  )
}
